...
const ContactCard = ({
  ...
  if (!href) {
    return (
      <div className="flex h-full items-center gap-5 rounded-3xl border border-transparent bg-surface p-4 shadow-soft md:p-7">
        {content}
      </div>
    );
  }
  ...
  return (
    <motion.a
      ...
      className="group flex h-full items-center gap-5 rounded-3xl border border-transparent bg-surface p-4 shadow-soft transition-shadow duration-300 hover:shadow-accent md:p-7"
    >
      {content}
    </motion.a>
  );
